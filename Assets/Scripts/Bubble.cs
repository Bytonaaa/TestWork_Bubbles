...
public class Bubble : MonoBehaviour
{
    ...
    {
        _level = level;
        _speed = _level * (1 + (END_GAME_BUBBLES_SPEED_SCALE - 1) * _gameMaster.m_secondsLeft / _gameMaster.m_playSeconds); //к концу игры скорость шарика того же уровня, будет в 4 раза больше, чем в начале игры. Можно вынести этот параметр в инспектор для настройки.
